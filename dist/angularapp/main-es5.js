(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MyListComponent = /** @class */ (function () {
                function MyListComponent(request) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ButtonSearchComponent = /** @class */ (function () {
                function ButtonSearchComponent() {
                    this.clickEmitter = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                }
                ButtonSearchComponent.prototype.handleClick = function () {
                    this.clickEmitter.emit();
                };
                return ButtonSearchComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GridListComponent = /** @class */ (function () {
                function GridListComponent(request) {
                    this.request = request;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InputTextComponent = /** @class */ (function () {
                ...
                InputTextComponent.prototype.sendText = function (text) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RequestService = /** @class */ (function () {
                ...
                RequestService.prototype.getRandomInt = function (min, max) {
                    return Math.floor(Math.random() * (max - min + 1)) + min;
                };
                RequestService.prototype.getRepos = function (type, lang, text) {
                    var _this = this;
                    var url = "https://api.github.com/search/repositories?q=" + text + "+language:" + lang;
                    var infoObservable = this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) { return resp.items; }));
                    var subscription = infoObservable.subscribe(function (items) {
                        var repos = items.map(function (repo) {
                            var starsNumber = repo.stargazers_count >= 1000 ? Math.trunc(repo.stargazers_count / 100) / 10 + "k" : repo.stargazers_count;
                            var isInTheList = _this.myList.find(function (item) { return item.name === repo.full_name; });
                            return {
                                name: repo.full_name,
                                stars: starsNumber,
                                lang: lang,
                                ...
                                id: _this.getRandomInt(1000, 9999)
                            };
                        });
                        _this.createReposList(repos);
                    });
                };
                RequestService.prototype.createReposList = function (list) {
                    this.list = list.filter(function (repo, index) {
                        if (index <= 19) {
                            return repo;
                        }
                    });
                ...
                RequestService.prototype.isInMyList = function (name) {
                    return this.myList.find(function (item) { return item.name === name; });
                };
                RequestService.prototype.changeViewParameters = function () {
                    if (this.list.length) {
                ...
                RequestService.prototype.addRepoToMyList = function (evt) {
                    var id = evt.target.id;
                    var clickedRepo = this.list.find(function (item) { return item.id == id; });
                    var isInTheList = this.myList.find(function (item) { return item.id == id; });
                    if (isInTheList) {
                        clickedRepo.buttonText = "add to list";
                        clickedRepo.buttonClass = "background__blue";
                        this.myList = this.myList.filter(function (item) { return item.id != id; });
                    }
                    else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _request_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../request.service */ "./src/app/search/request.service.ts");
            var ResultsBlockComponent = /** @class */ (function () {
                function ResultsBlockComponent(request) {
                    this.request = request;
                }
                return ResultsBlockComponent;
            }());
            ResultsBlockComponent.ctorParameters = function () { return [
                { type: _request_service__WEBPACK_IMPORTED_MODULE_2__["RequestService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _request_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../request.service */ "./src/app/search/request.service.ts");
            var RowsListComponent = /** @class */ (function () {
                function RowsListComponent(request) {
                    this.request = request;
                    this.linesColor = 'lines-black';
                    this.squaresColor = 'squares-grey';
                }
                return RowsListComponent;
            }());
            RowsListComponent.ctorParameters = function () { return [
                { type: _request_service__WEBPACK_IMPORTED_MODULE_2__["RequestService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var SearchAndResultsComponent = /** @class */ (function () {
                function SearchAndResultsComponent() {
                }
                return SearchAndResultsComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchBlockComponent = /** @class */ (function () {
                function SearchBlockComponent(request) {
                    this.request = request;
                    this.selects = [{
                            name: 'Type',
                ...
                SearchBlockComponent.prototype.addOption = function (value) {
                    var name = value[0].toLowerCase();
                    this["" + name] = value[1];
                };
                SearchBlockComponent.prototype.addText = function (text) {
                    this.text = text;
                };
                SearchBlockComponent.prototype.sendRequest = function () {
                    this.request.getRepos(this.type, this.language, this.text);
                };
                return SearchBlockComponent;
            }());
            SearchBlockComponent.ctorParameters = function () { return [
                { type: _request_service__WEBPACK_IMPORTED_MODULE_2__["RequestService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SelectComponent = /** @class */ (function () {
                ...
                SelectComponent.prototype.selectValue = function (event) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _request_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./request.service */ "./src/app/search/request.service.ts");
            var ShowViewFilterDirective = /** @class */ (function () {
                function ShowViewFilterDirective(templateRef, viewContainer, request) {
                    this.templateRef = templateRef;
                    this.viewContainer = viewContainer;
                    this.request = request;
                }
                Object.defineProperty(ShowViewFilterDirective.prototype, "appShowViewFilter", {
                ...
                return ShowViewFilterDirective;
            }());
            ShowViewFilterDirective.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _request_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../request.service */ "./src/app/search/request.service.ts");
            var ViewFilterComponent = /** @class */ (function () {
                function ViewFilterComponent(request) {
                    this.request = request;
                    this.rowsColor = 'rows-black';
                    this.gridColor = 'grid-grey';
                }
                ViewFilterComponent.prototype.toggleItemColor = function (clickedItem) {
                    if (clickedItem === 'rows') {
                        this.rowsColor = 'rows-black';
                        this.gridColor = 'grid-grey';
                    }
                ...
                ViewFilterComponent.prototype.handleClick = function (evt) {
                    var type = evt.target.classList[0];
                    this.request.displayType = type;
                    this.toggleItemColor(type);
                };
                return ViewFilterComponent;
            }());
            ViewFilterComponent.ctorParameters = function () { return [
                { type: _request_service__WEBPACK_IMPORTED_MODULE_2__["RequestService"] }
            ]; };
